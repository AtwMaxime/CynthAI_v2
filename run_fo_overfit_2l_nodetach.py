"""
FO overfit diagnostic — 2-layer Transformer critic, no detach.
critic_n_layers=2, critic_detach=False → full gradient flow backbone->critic.
"""
...
if __name__ == "__main__":
    ...
    cfg = TrainingConfig(
        ...
        critic_n_layers=2, critic_detach=False,
