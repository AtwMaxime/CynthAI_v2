"""Debug: Curriculum config, 40 updates on GPU to catch block."""
...
print(f"Device: {cfg.device}  n_envs={cfg.n_envs}  min_steps={cfg.min_steps}")
print("Starting...")
train(cfg)
print("DONE - no block detected in 40 updates")